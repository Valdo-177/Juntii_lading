...
import movil1 from '@/assets/img/dispath12.png'
import movil2 from '@/assets/img/dispath1.png'
...
const DischargeSection = () => {
    ...
    return (
        <section className='relative overflow-hidden w-full'>
            ...
            <div className='px-6 sm:px-4 sm:w-[70rem] mb-10 flex flex-col-reverse sm:flex-col justify-center mx-auto items-center gap-7'>
